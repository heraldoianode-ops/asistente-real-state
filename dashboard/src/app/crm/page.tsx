    ...
    <div className="flex h-screen bg-[hsl(var(--background))]">
      ...
      <main className="flex-1 overflow-auto p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-xl font-bold text-[hsl(var(--foreground))]">CRM — Clientes</h1>
                ...
                {filtered.map((c) => (
                  <tr key={c.id} className="hover:bg-[hsl(var(--secondary))] transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <StatusBadge
                        label={c.client_type === 'buyer' ? 'Comprador' : 'Vendedor'}
                        variant={c.client_type === 'buyer' ? 'active' : 'pending'}
                      />
                    </td>
